...
/**
 * WeatherActivity没有进行View和Presenter的分离，尝试和ChooseAreaFragment同用一个Presenter，好像不行
 * 如果要分离的话，需要重新添加一个Fragment实现界面，并将其填充到WeatherActivity，就不去实现了
 */
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //一定要在Weather中重新实例化Presenter，不然会出现意想不到的的效果。可以试试哦
    ...
    public void requestWeather(final String weatherId) {
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" +
                weatherId + "&key=8f9bb98d003b4d8f9a91ed19559e8137";
